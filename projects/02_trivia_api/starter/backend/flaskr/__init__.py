...
def create_app(test_config=None):
    ...
    def show_categories():
        try:
            ...
            categories = Category.query.with_entities(
                Category.type.label('type'), Category.id.label('id')).all()
    ...
    def show_questions():
        ...
        for category in categories:
            categoriesDict[category.id] = category.type
        current_category = Category.query.with_entities(
            Category.type.label('type')).first()
    ...
    def show_category_questions(id):
        current_category = Category.query.with_entities(
            Category.type.label("type")).filter(
